...
export const projectsData = [
    ...
    },
    {
        ...
        modalContent: {
            ...
            description: `
        <p>Developed an automation tool that logs into the Threads application, generates content using AI, and posts it automatically. This tool is used to post quotes on Instagram's Threads and is deployed on AWS and uses AWS Lambda and EventBridge Scheduler.</p>
        <p><strong>Technologies Used:</strong></p>
        <ul>
            ...
            <li><strong>AWS Lambda:</strong> For serverless deployment and execution.</li>
        </ul>
        <p><strong>Key Features:</strong></p>
        <ul>
            <li>Automated login to the Threads application.</li>
            <li>AI-generated content creation.</li>
            <li>Scheduled and cloud-based posting of quotes.</li>
        </ul>
    `
        }
    },
